...
<body style="padding-top: 50px;">
    ...
    <div class="container">
        <!-- Jumbotron Header -->
            <div class="jumbotron home-spacer" id="products-jumbotron" style="background-color: #8DE3DA;">
                <center><h1 style="color:#760080">Welcome to our online Store</h1>
                <p style="text-transform:capitalize;color:#E75129;font-family:verdana;">We have a Best Smartphones Under Your Comfortable Budget. No Need to go around any place come here at one place for a offardable smartphone, Tablets and many more gadets with best quality assurance and a good service to. </p>
              </center>
            </div>
            <hr>
            <br>
        ...
        <div class="row">
            <div class="col-sm-3" >
               ...
               <div class="panel panel-default">
                    <div class="panel-heading color" style="background-color: #8DE3DA;">
                        <h3 style="color:#760080;">Brands</h3>
                    </div>
               ...
               <br>
                <div class="panel panel-default">
                    <div class="panel-heading  color" style="background-color: #8DE3DA;">
                        <h3 style="color:#760080">Operating System</h3>
                    </div>
            ...
            <div class="col-sm-9 text-center">
                <div class="panel-group">
                  <!----------------------------------------------------featured phone----------------------------------->
                   <div class="panel panel-default">
                        <div class="panel-heading  color" style="background-color: #8DE3DA;">
                            <h3 style="color:#760080">Featured Mobile</h3>
                        </div>
                ...
                <div class="panel panel-default">
                        <div class="panel-heading  color" style="background-color: #8DE3DA;">
                            <h3 id="ios" style="color:#760080">apple</h3>
                        </div>
                ...
                <div class="panel panel-default">
                        <div class="panel-heading  color" style="background-color: #8DE3DA;">
                            <h3 id="samsung" style="color:#760080">samsung</h3>
                        </div>
                ...
                <div class="panel panel-default">
                        <div class="panel-heading  color" style="background-color: #8DE3DA;">
                            <h3 id="oneplus" style="color:#760080">oneplus</h3>
                        </div>
                   ...
                   <div class="panel panel-default">
                        <div class="panel-heading  color" style="background-color: #8DE3DA;">
                            <h3 id="xiaomi" style="color:#760080">xiaomi</h3>
                        </div>
